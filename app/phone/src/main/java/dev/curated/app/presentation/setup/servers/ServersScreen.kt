package dev.curated.app.presentation.setup.servers
...
import dev.curated.app.presentation.setup.components.ServerBottomSheet
import dev.curated.app.presentation.setup.components.ServerItem
...
fun ServersScreen(
    ...
    ObserveAsEvents(viewModel.events) { event ->
        when (event) {
            is ServersEvent.NavigateHome -> navigateHome()
            is ServersEvent.NavigateAuthLock -> navigateToAuthLock()
            else -> Unit
        }
    }
