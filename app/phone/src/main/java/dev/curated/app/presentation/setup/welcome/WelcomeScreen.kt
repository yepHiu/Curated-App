package dev.curated.app.presentation.setup.welcome
...
import dev.curated.app.setup.presentation.welcome.WelcomeAction
...
private fun WelcomeScreenLayoutPreview() {
    CuratedTheme { WelcomeScreenLayout(onAction = {}) }
}
