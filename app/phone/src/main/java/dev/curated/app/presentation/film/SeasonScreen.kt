...
import dev.curated.app.film.presentation.season.SeasonAction
import dev.curated.app.film.presentation.season.SeasonState
import dev.curated.app.film.presentation.season.SeasonViewModel
import dev.curated.app.models.FindroidItem
import dev.curated.app.presentation.film.components.Direction
import dev.curated.app.presentation.film.components.EpisodeCard
...
private fun SeasonScreenLayoutPreview() {
    CuratedTheme { SeasonScreenLayout(state = SeasonState(season = dummySeason), onAction = {}) }
}
