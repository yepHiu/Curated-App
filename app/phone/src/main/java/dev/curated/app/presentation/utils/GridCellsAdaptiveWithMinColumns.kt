...
/**
 * Based on [GridCells.Adaptive] with the added [minColumns] variable. [minColumns] takes precedence
 * over [minSize].
 */
class GridCellsAdaptiveWithMinColumns(private val minSize: Dp, private val minColumns: Int) :
    ...
    override fun equals(other: Any?): Boolean {
        return other is GridCellsAdaptiveWithMinColumns &&
            minSize == other.minSize &&
            minColumns == other.minColumns
    }
}
