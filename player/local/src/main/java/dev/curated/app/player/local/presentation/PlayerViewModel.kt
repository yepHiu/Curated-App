package dev.curated.app.player.local.presentation
...
import dev.curated.app.models.FindroidSegmentType
import dev.curated.app.player.core.domain.models.PlayerChapter
import dev.curated.app.player.core.domain.models.PlayerItem
import dev.curated.app.player.core.domain.models.Trickplay
import dev.curated.app.player.local.R
import dev.curated.app.player.local.domain.PlaylistManager
import dev.curated.app.player.local.mpv.MPVPlayer
import dev.curated.app.repository.JellyfinRepository
import dev.curated.app.settings.domain.AppPreferences
import dev.curated.app.settings.domain.Constants
